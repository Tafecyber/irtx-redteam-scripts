...
echo -e "${CYAN}           1433,1521,2222,3000,3001,3002,3306,3389,4444,5900,6667,8000,8080,8443,9200,10000${RESET}"
echo ""

HOSTS_INLINE=$(paste -sd' ' "$LIVE_HOSTS")

nmap -sS -sV -O \
    -p 21,22,23,25,53,80,110,135,139,443,445,1433,1521,2222,3000,3001,3002,3306,3389,4444,5900,6667,8000,8080,8443,9200,10000 \
    -n \
    -T3 \
    --open \
    $HOSTS_INLINE \
